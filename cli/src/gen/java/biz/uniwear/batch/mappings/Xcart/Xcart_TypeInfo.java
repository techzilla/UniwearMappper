...
public class Xcart_TypeInfo
{
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _price = 3 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator
	{
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[2] = new MemberInfo (binder, "", "name", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[3] = new MemberInfo (binder, "", "price", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);

			members[4] = new MemberInfo (binder, "", "", _altova_ti_altova_stringType, _altova_ti_altova_string2, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

			members[5] = new MemberInfo (binder, "", "", _altova_ti_altova_decimalType, _altova_ti_altova_decimal, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

		}

		public MemberInfo[] createMembers(InfoBinderInterface binder) {

			MemberInfo members[] = new MemberInfo[6];
