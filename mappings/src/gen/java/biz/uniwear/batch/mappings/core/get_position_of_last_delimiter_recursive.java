	...
	static class main implements IEnumerable
	{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_6() throws Exception {
				state = 0;				
				current = biz.uniwear.batch.mappings.core.get_position_of_last_delimiter_recursive.eval(closure.var1_filepath, com.altova.functions.Core.subtract(closure.var2_pos, new java.math.BigDecimal("1")), closure.var3_delimiter1, closure.var4_delimiter2);
				pos++;
				return true;
			}
