...
public class SPIMapToBatch extends com.altova.TraceProvider 
{
	...
	static class seq2_map implements IEnumerable
	{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_2() throws Exception {
				...
				com.altova.db.Dbs.writeField(var3_NewRecord, "sku", (new seq3_join(var4_filter_elements_nodename, ((com.altova.mapforce.IMFNode)(var2_filter_elements_nodename.current())), var5_filter_elements_nodename)));
				...
				com.altova.db.Dbs.writeField(var3_NewRecord, "price", (new seq10_join(((com.altova.mapforce.IMFNode)(var2_filter_elements_nodename.current())), var6_filter_elements_nodename)));
	...
	static class seq3_join implements IEnumerable
	{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_6() throws Exception {
				...
				if (!(com.altova.functions.Core.exists(closure.var3_filter_elements_nodename))) {state = 6; return false; }
				var7_filter_elements_nodename = (closure.var3_filter_elements_nodename).enumerator();
				return false;
			}
