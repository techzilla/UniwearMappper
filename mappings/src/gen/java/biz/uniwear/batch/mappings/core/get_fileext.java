	...
	static class main implements IEnumerable
	{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_2() throws Exception {
				state = 0;				
				if (!(com.altova.functions.Core.equalOrGreater(biz.uniwear.batch.mappings.core.get_position_of_last_delimiter.eval(closure.var1_filepath, "\\", "/"), biz.uniwear.batch.mappings.core.get_position_of_last_delimiter.eval(closure.var1_filepath, ".", ".")))) {state = 3; return false; }
				current = "";
				pos++;
				return true;
			}
			private boolean moveNext_3() throws Exception {
				state = 0;				
				current = com.altova.functions.Core.substring(closure.var1_filepath, com.altova.CoreTypes.decimalToDouble(biz.uniwear.batch.mappings.core.get_position_of_last_delimiter.eval(closure.var1_filepath, ".", ".")), com.altova.CoreTypes.integerToDouble(com.altova.CoreTypes.longToInteger(com.altova.CoreTypes.intToLong(com.altova.functions.Core.stringLength(closure.var1_filepath)))));
				pos++;
				return true;
			}
