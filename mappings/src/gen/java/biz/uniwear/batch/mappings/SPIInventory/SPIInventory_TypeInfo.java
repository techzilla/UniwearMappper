...
package biz.uniwear.batch.mappings.SPIInventory;

import com.altova.typeinfo.*;



public class SPIInventory_TypeInfo
{
	// namespaces indices
	...
	public static final int _altova_ti_altova_decimalType = 16 ;
	public static final int _altova_til = 17 ;
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _Style = _altova_mi_altova_RowsType.begin ;
		public static final int _Color = 2 ;
		public static final int _Color_Description = 3 ;
		...
		public static final int _First_Season = 11 ;
		public static final int _Garment_Type = 12 ;
		public static final int _Color_Type = 13 ;
		public static final int _Status = 14 ;
		public static final int _Makable = 15 ;
		public static final int _Availability = 16 ;
		public static final int _Date_Available = 17 ;
		public static final int _Coordinating_Colors = 18 ;
		public static final int _Collection = 19 ;
		public static final int _Brand = 20 ;
		public static final int _MAP_Price = 21 ;
		public static final int _Meta_Data = 22 ;
		public static final int _Product_Shot = 23 ;
		public static final int _Product_Back = 24 ;
		public static final int _Color_Swatch = 25 ;
		public static final int _Gender = 26 ;
		public static final int _Fit = 27 ;
	...
	public static class _altova_mi_altova_decimalType {
		public static final int begin = _altova_mi_altova_integerType.end ;
...
// Array of all types with pointers to members:
	...
	private static class TypeInfoCreator
	{
		private void initTypes0(InfoBinderInterface binder, TypeInfo[] types) {
			...
			types[16] = new TypeInfo( binder, _altova_ni, "", 0, _altova_mi_altova_decimalType.begin, _altova_mi_altova_decimalType.end,  null, 				WhitespaceType.Whitespace_Unknown, com.altova.text.Xs.DecimalFormatter );

		}

		public TypeInfo[] createTypes(InfoBinderInterface binder) {

			TypeInfo types[] = new TypeInfo[17];
	...
	private static class MemberInfoCreator
	{
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[1] = new MemberInfo (binder, "", "Style", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[2] = new MemberInfo (binder, "", "Color", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			...
			members[11] = new MemberInfo (binder, "", "First Season", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[12] = new MemberInfo (binder, "", "Garment Type", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[13] = new MemberInfo (binder, "", "Color Type", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[14] = new MemberInfo (binder, "", "Status", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[15] = new MemberInfo (binder, "", "Makable", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[16] = new MemberInfo (binder, "", "Availability", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[17] = new MemberInfo (binder, "", "Date Available", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[18] = new MemberInfo (binder, "", "Coordinating Colors", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[19] = new MemberInfo (binder, "", "Collection", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[20] = new MemberInfo (binder, "", "Brand", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[21] = new MemberInfo (binder, "", "MAP Price", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);
			members[22] = new MemberInfo (binder, "", "Meta Data", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[23] = new MemberInfo (binder, "", "Product Shot", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[24] = new MemberInfo (binder, "", "Product Back", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[25] = new MemberInfo (binder, "", "Color Swatch", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[26] = new MemberInfo (binder, "", "Gender", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[27] = new MemberInfo (binder, "", "Fit", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			...
			members[34] = new MemberInfo (binder, "", "", _altova_ti_altova_integerType, _altova_ti_altova_integer, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

			members[35] = new MemberInfo (binder, "", "", _altova_ti_altova_decimalType, _altova_ti_altova_decimal, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

		}

		public MemberInfo[] createMembers(InfoBinderInterface binder) {

			MemberInfo members[] = new MemberInfo[36];
